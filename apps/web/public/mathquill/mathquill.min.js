!(function () {
  ...
  function c(e) {
    function n(t) {
      var e, n;
      return t && t.nodeType
        ? ((e = x(t).children(".mq-root-block").attr(Ft)),
    ...
    function i(t, e) {
      ...
      for (n in e)
        e.hasOwnProperty(n) && ((i = e[n]), (r = E[n]), (t[n] = r ? r(i) : i));
    }
    var s, r, o;
    if (!(R <= e && e <= z))
      throw (
          ...
          (t.init = function (t) {
            ...
            (t.__mathquillify = function (t) {
              ...
              n.createTextarea(),
                ...
                (i.jQ = x('<span class="mq-root-block"/>')
                  .attr(Ft, i.id)
                  .appendTo(s)),
                this.latex(e.text()),
      ...
      (s.EditableField = v(r, function (e, n) {
        (e.__mathquillify = function () {
          ...
          (e.select = function () {
            ...
            for (t.notify("move").cursor.insAtRightEnd(t.root); t.cursor[w]; )
              t.selectLeft();
            return this;
          }),
          ...
          (e.dropEmbedded = function (t, e, n) {
            var i,
              s = t - x(window).scrollLeft(),
              r = e - x(window).scrollTop(),
              o = document.elementFromPoint(s, r);
            this.__controller.seek(x(o), t, e),
              (i = gt().setOptions(n)),
          ...
          (e.clickAt = function (t, e, n) {
            ...
            return (
              ...
              i.seek(x(n), t + pageXOffset, e + pageYOffset),
          ...
          (e.ignoreNextMousedown = function (t) {
            return (
              (this.__controller.cursor.options.ignoreNextMousedown = t), this
            );
          });
      })),
  ...
  function p(t, e) {
    (t.jQadd = function () {
      ...
      (t.reflow = function () {
        ...
        Z(this.delimjQs, $t(1 + 0.2 * (t - 1), 1.2), 1.2 * t);
      });
  }
  function d(t, e) {
    var e = e || t,
  ...
  (g = [].slice),
      ...
      return function t(n, o) {
        ...
        return (
          ...
          (a.open = function (t) {
            if (
              ((u = {}),
              s(t) ? (u = t.call(a, h, c, a, n)) : i(t) && (u = t),
              i(u))
            )
        ...
        (t.disown = function () {
          ...
          return !i || n.disowned
            ...
            : ((n.disowned = !0),
              ...
              o(e, i[w], i),
              o(e, t, t[q]),
              i[w] ? (i[w][q] = t[q]) : (e.ends[w] = t[q]),
              t[q] ? (t[q][w] = i[w]) : (e.ends[q] = i[w]),
              n);
        }),
        (t.remove = function () {
          return (
    ...
    (T = v(y, function (t) {
      (t.init = function (t, e) {
            ...
            "intervalId" in this
              ...
              : (this[q]
                  ? this.selection && this.selection.ends[w][w] === this[w]
                    ...
                    : this.jQ.insertBefore(this[q].jQ.first())
        ...
        (t.unwrapGramp = function () {
          ...
          this[q] ? this.insLeftOf(this[q]) : this.insAtRightEnd(e),
            t.jQ.remove(),
            t[w].siblingDeleted && t[w].siblingDeleted(i.options, q),
            t[q].siblingDeleted && t[q].siblingDeleted(i.options, w);
        }),
        ...
        (t.deleteSelection = function () {
          this.selection &&
            ...
            (this[q] = this.selection.ends[q][q]),
    ...
    (M = (function () {
      ...
      return function (n, i) {
        ...
        var g,
          ...
          y = t;
        return (
          x.bind("keydown keypress input keyup focusout paste", function (t) {
            y(t);
          }),
          (b = !1),
          x.bind({
    ...
    (F = (function () {
      ...
      function e(t) {
        ...
        for (e = 1; e < t.length; e += 1)
          t[e].children().adopt(n, n.ends[q], 0);
        return n;
      }
      var n = B.string,
        i = B.regex,
      ...
      (t.exportLatex = function () {
        ...
        (t.writeLatex = function (t) {
          ...
          return (
            r &&
              !r.isEmpty() &&
              (r.children().adopt(n.parent, n[w], n[q]),
              (e = r.jQize()),
              e.insertBefore(n.jQ),
              (n[w] = r.ends[q]),
              r.finalizeInsert(n.options, n),
              r.ends[q][q].siblingCreated &&
                r.ends[q][q].siblingCreated(n.options, w),
              r.ends[w][w].siblingCreated &&
                r.ends[w][w].siblingCreated(n.options, q),
    ...
    O.open(function (t) {
      (t.keystroke = function (t, e, n) {
        ...
        switch (t) {
          ...
          case "Meta-A":
          case "Ctrl-A":
            for (n.notify("move").cursor.insAtRightEnd(n.root); i[w]; )
              n.selectLeft();
            break;
          default:
            return;
      ...
      this.onNotify(function (t) {
        ...
        (t.deleteDir = function (t) {
          ...
          return (
            ...
            e[w].siblingDeleted && e[w].siblingDeleted(e.options, q),
            e[q].siblingDeleted && e[q].siblingDeleted(e.options, w),
      ...
      (D.p.substituteTextarea = function () {
        ...
        (t.staticMathTextareaEvents = function () {
          ...
          this.container.prepend(
            Mt('<span class="mq-selectable">').text(
              "$" + e.exportLatex() + "$",
            ),
          ),
            (e.blurred = !0),
        ...
        (D.p.substituteKeyboardEvents = M),
          ...
          this.container.bind("mousedown.mathquill", function (n) {
            ...
            function r(t) {
              (h.blink = u),
                ...
                x(t.target.ownerDocument)
                  .unbind("mousemove", s)
                  .unbind("mouseup", r);
            }
            var o,
              a = x(n.target).closest(".mq-root-block"),
            ...
            n.preventDefault(),
              ...
              h.options.ignoreNextMousedown(n) ||
                ...
                (h.blink = t),
                c.seek(x(n.target), n.pageX, n.pageY).cursor.startSelection(),
                a.mousemove(i),
                x(n.target.ownerDocument).mousemove(s).mouseup(r));
          });
        });
    }),
    S.open(function (t) {
      t.seek = function (t, e, n) {
        ...
        return (
          t &&
            ((i = t.attr(Ft) || t.attr(Bt)) ||
              ((r = t.parent()), (i = r.attr(Ft) || r.attr(Bt)))),
    ...
    S.open(function (t) {
      t.scrollHoriz = function () {
        ...
        else if ((t = r.jQ[0].getBoundingClientRect().left) > a.right - 20)
          e = t - (a.right - 20);
        else {
    ...
    ($ = v(O, function (t, e) {
      t.finalizeInsert = function (t, e) {
        ...
        n.postOrder("finalizeTree", t),
          ...
          n.postOrder("blur"),
          n.postOrder("reflow"),
          n[q].siblingCreated && n[q].siblingCreated(t, w),
          n[w].siblingCreated && n[w].siblingCreated(t, q),
          n.bubble("reflow");
      };
    })),
    (P = v($, function (t, e) {
      (t.init = function (t, n, i) {
        ...
        (t.seek = function (t, e) {
          function n(t) {
            var e = {};
            return (
              (e[w] = t.jQ.offset().left), (e[q] = e[w] + t.jQ.outerWidth()), e
            );
          }
          var i,
            s = this,
    ...
    (V = v($, function (t, e) {
      (t.join = function (t) {
        ...
        (t.text = function () {
          return this.ends[w] === this.ends[q] && 0 !== this.ends[w]
            ? this.ends[w].text()
            : this.join("text");
        }),
        (t.keystroke = function (t, n, i) {
          return !i.options.spaceBehavesLikeTab ||
            ...
            : (n.preventDefault(),
              void i.escapeDir("Shift-Spacebar" === t ? w : q, t, n));
        }),
    ...
    (G = v(O, function (t, e) {
      ...
      (t.ctrlSeq = "\\text"),
        ...
        (t.jQadd = function (t) {
          e.jQadd.call(this, t),
            this.ends[w] && this.ends[w].jQadd(this.jQ[0].firstChild);
        }),
        (t.createLeftOf = function (t) {
          var n,
            i = this;
          if (
            ...
            i[q].siblingCreated && i[q].siblingCreated(t.options, w),
            i[w].siblingCreated && i[w].siblingCreated(t.options, q),
            i.bubble("reflow"),
            t.insAtRightEnd(i),
            i.replacedText)
          )
        ...
        (t.latex = function () {
          ...
          return 0 === t.length
            ? ""
            : "\\text{" +
                t.replace(/\\/g, "\\backslash ").replace(/[{}]/g, "\\$&") +
                "}";
        }),
        (t.html = function () {
          return (
            ...
            e.anticursor
              ? e.anticursor.parent === this &&
                ...
                this.anticursorPosition === c
                  ...
                  : (this.anticursorPosition < c
                      ? ((h = e[w].splitRight(this.anticursorPosition)),
                        (e[w] = h))
                      : (h = e[q].splitRight(this.anticursorPosition - c)),
      ...
      (t.ctrlSeq = "\\"),
        ...
        (t.renderCommand = function (t) {
          ...
          (this.jQ = this.jQ.last()),
            this.remove(),
            this[q] ? t.insLeftOf(this[q]) : t.insAtRightEnd(this.parent),
            (e = this.ends[w].latex()),
            e || (e = " "),
            (n = j[e] || bt[e]),
            n
  ...
  it
    ...
    (j.overarc = i(rt, "\\overarc", "span", 'class="mq-non-leaf mq-overarc"')),
                    ...
                    (s
                      ? i.isEmpty()
                        ...
                        : (i.jQ.children().insAtDirEnd(-e, s.jQ),
                          (r = i.children().disown()),
                          (o = y(s, r.ends[q], s.ends[w])),
                          e === w
                            ? r.adopt(s, s.ends[q], 0)
                            : r.adopt(s, 0, s.ends[w]))
        ...
        (t.deleteTowards = function (t, n) {
          if (n.options.autoSubscriptNumerals && this.sub) {
            ...
            i instanceof N
              ...
              this.sub.isEmpty() &&
                (this.sub.deleteOutOf(w, n.insAtLeftEnd(this.sub)),
            ...
            !(function (t, e, n, i) {
              t[e].deleteOutOf = function (s, r) {
                ...
                (t.supsub = n),
                  ...
                  "sub" === e &&
                    x(t.jQ.addClass("mq-sup-only")[0].lastChild).remove(),
                  this.remove();
              };
            })(
              this,
      ...
      j["^"] =
        v(ot, function (t, e) {
          (t.supsub = "sup"),
            ...
            (t.textTemplate = ["^"]),
            (t.finalizeTree = function () {
              (this.upInto = this.sup = this.ends[q]),
            ...
            (t.reflow = function () {
              ...
              (e *= 0.6), t.css("vertical-align", e + "px");
            });
        })),
    (at = v(P, function (t, e) {
      (t.init = function (t, e) {
        ...
        (t.createLeftOf = function (t) {
          e.createLeftOf.apply(this, arguments),
            t.options.sumStartsWithNEquals &&
              (Ot("n").createLeftOf(t), Rt().createLeftOf(t));
        }),
        (t.latex = function () {
          function t(t) {
        ...
        (t.finalizeTree = function () {
          (this.downInto = this.ends[w]),
            (this.upInto = this.ends[q]),
            (this.ends[w].upOutOf = this.ends[q]),
            (this.ends[q].downOutOf = this.ends[w]);
        });
    })),
      ...
      j.fraction =
        v(P, function (t, e) {
          (t.ctrlSeq = "\\frac"),
            ...
            (t.textTemplate = ["(", ")/(", ")"]),
            (t.finalizeTree = function () {
              (this.upInto = this.ends[q].upOutOf = this.ends[w]),
                (this.downInto = this.ends[w].downOutOf = this.ends[q]);
            });
        })),
    (ct =
      j.over =
          ...
          e.createLeftOf = function (e) {
            if (!this.replacedFragment) {
              ...
              i instanceof at &&
                i[q] instanceof ot &&
                ((i = i[q]),
                i[q] instanceof ot && i[q].ctrlSeq != i.ctrlSeq && (i = i[q])),
                i !== e[w] &&
                  (this.replaces(k(i[q] || e.parent.ends[w], e[w])),
                  (e[w] = i));
            }
            ...
            i
              ...
              : ((i = this),
                ...
                i.replacedFragment
                  ? (i.side = 0)
                  : t[-s] &&
                    (i.replaces(k(t[-s], t.parent.ends[-s], s)), (t[-s] = 0)),
    ...
    (j.rangle = i(pt, q, "&lang;", "&rang;", "\\langle ", "\\rangle ")),
    (Q["|"] = i(pt, w, "|", "|", "|", "|")),
    (j.lVert = i(pt, w, "&#8741;", "&#8741;", "\\lVert ", "\\rVert ")),
    (j.rVert = i(pt, q, "&#8741;", "&#8741;", "\\lVert ", "\\rVert ")),
        ...
        return t("{")
          ...
          .then(function (e) {
            return (
              bt[e]
                ? bt[e]().parser()
                : B.fail("unknown environment type: " + e)
            ).skip(t("\\end{" + e + "}"));
          });
      };
    })),
      ...
      v(vt, function (t, e) {
        ...
        (t.parentheses = { left: null, right: null }),
          ...
          (t.reflow = function () {
            ...
            n.length && Z(n, $t(1 + 0.2 * (e - 1), 1.2), 1.05 * e);
          }),
          (t.latex = function () {
            var t,
              e = "";
            return (
              this.eachChild(function (i) {
                void 0 !== t && (e += t !== i.row ? n.row : n.column),
                  (t = i.row),
                  (e += i.latex());
              }),
          ...
          (t.html = function () {
            function t(t) {
              return t
                ? '<span class="mq-scaled mq-paren">' + t + "</span>"
                : "";
            }
            var n,
              i = [],
          ...
          (t.relink = function () {
            ...
            for (this.rowSize = s.length, i = 0; i < s.length; i += 1)
              (n = s[i]),
                ...
                r[t - 1] &&
                  r[t - 1][e] &&
                  ((n.upOutOf = r[t - 1][e]), (r[t - 1][e].downOutOf = n)),
                (e += 1);
          ...
          (t.deleteCell = function (t) {
            ...
            function n(t) {
              for (var e = 0; e < t.length; e += 1)
                c.indexOf(t[e]) > -1 &&
                  (t[e].remove(), c.splice(c.indexOf(t[e]), 1));
            }
            var i,
              s,
              r = [],
          ...
          (t.addRow = function (t) {
            ...
            for (
              ...
              (e = qt(l + 1)),
                (e.parent = this),
                r.push(e),
                (e.jQ = x('<td class="mq-empty">').attr(Ft, e.id).appendTo(a));
            return (
              this.jQ.find("tr").eq(l).after(a),
          ...
          (t.addColumn = function (t) {
            ...
            for (
              ...
              (n = qt(i)),
                ...
                r.push(n),
                s[i].splice(e, 0, n),
                (n.jQ = x('<td class="mq-empty">').attr(Ft, n.id));
            return (
    ...
    (qt = v(V, function (t, e) {
      (t.init = function (t, n, i) {
        if (
          (e.init.call(this),
          (this.row = t),
          n && this.adopt(n, n.ends[q], 0),
          i)
        )
          for (var s = 0; s < i.length; s++)
            i[s].children().adopt(this, this.ends[q], 0);
      }),
        (t.keystroke = function (t, n, i) {
          switch (t) {
            case "Shift-Spacebar":
  ...
  (j.impliedby = i(U, "\\Leftarrow ", "&lArr;")),
          ...
          return (
            this.isPartOfOperator
              ...
              : (!this[w] ||
                ...
                !this[q] ||
                  this[q] instanceof U ||
                  this[q] instanceof ot ||
                  (t += "*")),
            t
          );
        });
    })),
    (D.p.autoCommands = { _maxLength: 0 }),
    ...
    (Ot = v(yt, function (t, e) {
      ...
      (t.init = function (t) {
          ...
          if (
            ...
            for (; s.length; ) {
              if (n.hasOwnProperty(s)) {
                ...
                return (
                  k(r, this).remove(), (t[w] = r[w]), j[s](s).createLeftOf(t)
                );
              }
              s = s.slice(1);
            }
        ...
        (t.autoUnItalicize = function (t) {
          ...
          if (0 !== d._maxLength) {
            for (e = this.letter, i = this[w]; i instanceof Ot; i = i[w])
              e = i.letter + e;
            for (s = this[q]; s instanceof Ot; s = s[q]) e += s.letter;
            k(i[q] || this.parent.ends[w], s[w] || this.parent.ends[q]).each(
              function (t) {
                t
                  .italicize(!0)
                  .jQ.removeClass("mq-first mq-last mq-followed-by-supsub"),
                  (t.ctrlSeq = t.letter);
              },
            );
            t: for (
              r = 0, o = i[q] || this.parent.ends[w];
              r < e.length;
              r += 1, o = o[q]
            )
              for (a = $t(d._maxLength, e.length - r); a > 0; a -= 1)
                if (((l = e.slice(r, r + a)), d.hasOwnProperty(l))) {
                  for (c = 0, h = o; c < a; c += 1, h = h[q])
                    h.italicize(!1), (u = h);
                  (f = kt.hasOwnProperty(l)),
                    ...
                    n(u[q]) ||
                      (u[q] instanceof ot
                        ? ((p = u[q]),
                          (p.siblingCreated = p.siblingDeleted =
                            function () {
                              p.jQ.toggleClass(
                        ...
                        : u.jQ.toggleClass("mq-last", !(u[q] instanceof pt))),
                    (r += a - 1),
                    (o = u);
                  continue t;
                }
    ...
    (kt = {}),
    (jt = D.p.autoOperatorNames = { _maxLength: 9 }),
      ...
      (t.init = function (t) {
        ...
        (t.parser = function () {
          ...
          for (t = 0; t < e.length; t += 1)
            Ot(e.charAt(t)).adopt(n, n.ends[q], 0);
  ...
  (j.operatorname = v(P, function (e) {
    ...
    (j.Upsilon =
      ...
      j.upsih =
      j.Upsih =
        i(N, "\\Upsilon ", '<var style="font-family: serif">&upsih;</var>')),
    (j.Gamma =
      j.Delta =
      j.Theta =
      j.Lambda =
    ...
    (_t = v(P, function (t) {
      (t.init = function (t) {
        ...
        (t.createLeftOf = function (t) {
          ...
          e.children().adopt(t.parent, t[w], t[q]),
            (t[w] = e.ends[q]),
            e.jQize().insertBefore(t.jQ),
            e.finalizeInsert(t.options, t),
            e.ends[q][q].siblingCreated &&
              e.ends[q][q].siblingCreated(t.options, w),
            e.ends[w][w].siblingCreated &&
              e.ends[w][w].siblingCreated(t.options, q),
    ...
    (j["+"] = i(Dt, "+", "+")),
    (j["–"] = j["-"] = i(Dt, "-", "&minus;")),
    (j["±"] = j.pm = j.plusmn = j.plusminus = i(Dt, "\\pm ", "&plusmn;")),
    (j.mp = j.mnplus = j.minusplus = i(Dt, "\\mp ", "&#8723;")),
